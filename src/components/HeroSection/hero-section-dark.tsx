...
const HeroSection = React.forwardRef<HTMLDivElement, HeroSectionProps>(
  (
    {
      className,
      title = "Collaborative Skill Exchange",
      subtitle = {
        regular: "Get Help, Give Help, and ",
        gradient: "Grow Together.",
      },
      description = "SkillSwap is a platform for developers and creators to collaborate, exchange skills, and earn tokens while solving real-world problems.",
